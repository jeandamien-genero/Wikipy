...
"""
    ...
    Script that updates wp:fr's list of current french ambassadors ("Liste des ambassadeurs français", (https://fr.wikipedia.org/wiki/Liste_des_ambassadeurs_fran%C3%A7ais) with data from a JSON of the JORFSearch website (https://jorfsearch.steinertriples.fr/tag/ambassadeur_pays?format=JSON).
"""
...
site = pywikibot.Site()
page = pywikibot.Page(site, "Liste des ambassadeurs français")
...
# lines that will not be changed (2nd & co lines : non-resident ambassadors)
no_modif = ["Russie", "Laos", "États-Unis", "Cameroun",
            "Nauru", "Tuvalu", "Kiribati", "Tonga", "Sao Tomé-et-Principe", "Sierra Leone", "Timor oriental",
            "Saint-Marin", "Swaziland", "Îles Cook", "Samoa", "Îles Samoa", "Bahamas", "Salomon", "Îles Marshall",
            "Micronésie", "Palaos", "Antigua-et-Barbuda", "Barbade", "Dominique", "Grenade",
            "Saint-Christophe-et-Niévès", "Saint-Vincent-et-les-Grenadines", "Belize", "Gambie", "Maldives",
            "Liechtenstein", "Guyana", "Barbade", "Malawi", "Eswatini", "Lesotho", "Saint-Vincent-et-les Grenadines"]
